...
class DeliveryViewModelTest: BaseTest {
    ...
    func test_getPackagesForDelivery() {
        setupViewModel()
        ...
        XCTAssertEqual(viewModel.getPackagesForDelivery(packages: packages, maxCarriableWeightInKG: maxCarriableWeightInKG), [packages[1], packages[3]])
        ...
        XCTAssertEqual(viewModel.getPackagesForDelivery(packages: packages, maxCarriableWeightInKG: maxCarriableWeightInKG), [packages[0], packages[2], packages[3]])
        ...
        XCTAssertEqual(viewModel.getPackagesForDelivery(packages: packages, maxCarriableWeightInKG: maxCarriableWeightInKG), [packages[0], packages[1]])
